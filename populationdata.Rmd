...
<script>
  function lookupCountryInfo(val) {
    ...
    var lookup = {
      "Population Density": "<p><div style='width:95%%'><div style='font-size:12px;width:200px;float:left'><span style='float:left'>Population : 1,210,854,977 </span><br/><span style='float:left'>Area (sqkm): 3,287,240<sup>[2]</sup> </span><br/><span style='float:left'>Population Density: 382 per sqkm</span></div></div></p>",
      
      "Population Growth %": "<p><div style='width:95%%'><div style='font-size:12px;width:200px;float:left'><span style='float:left'>Population Growth: 17.64 %%</span><br/><span style='float:left'>Population: 1,210,854,977</span></div></div></p>",
      
      "Literacy Rate %": "<p><div style='width:95%%'><div style='font-size:12px;width:200px;float:left'><span style='float:left'>Literacy Rate: 74.04 %%</span><br/><span style='float:left'>Population: 1,210,854,977</span><br/><span style='float:left'>Non-literate: ~314,337,952</span></div></div></p>",
...
map <- leaflet(width = "100%") %>% 
  ...
  addLegend("bottomleft", pal = mapspalettePopD, values = plotSubset$`Density (per sqkm)`, title = "Population Density", opacity = 1) %>%
  addLegend("bottomleft", pal = mapspalettePOPG, values = plotSubset$`Decadal Growth%(2001-2011)`, title = "Population Growth %", opacity = 1, group = "Population Growth %", layerId = "Population Growth %" ) %>%
  legendreverse("bottomleft", pal = mapspaletteLit, values = plotSubset$`Literacy Rate (%)`, title = "Literacy Rate %", opacity = 1, group = "Literacy Rate %", layerId = "Literacy Rate %" , decreasing = T) %>% 
  legendreverse("bottomleft", pal = mapspaletteGR, values = plotSubset$`Gender Ratio`, opacity = 1, decreasing = T, title = "Gender Ratio", group = "Gender Ratio", layerId = "Gender Ratio" ) %>%
  legendreverse("bottomleft", pal = mapspaletteUR, values = as.numeric(plotSubset$`Urban Rural Ratio`), decreasing = T, opacity = 1, title = "Urban:Rural", group = "Urban:Rural", layerId = "Urban:Rural" ) %>%
...
htmlwidgets::onRender("
  ...
  addLayersControl(
    baseGroups = c("Population Density", "Population Growth %", "Literacy Rate %", "Gender Ratio", "Urban:Rural"),
