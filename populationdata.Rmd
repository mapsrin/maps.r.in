...
<script>
  function lookupCountryInfo(val) {
    ...
    var lookup = {
      "Population Density": "<p><div style='width:95%%'><div style='font-size:12px;width:200px;float:left'><span style='float:left'>Population:</span><span style='float:right'> 1,210,854,977 </span><br/><span style='float:left'>Area (sqkm):</span><span style='float:right'> 3,287,240<sup>[2]</sup> </span><br/><span style='float:left'>Population Density:</span><span style='float:right'> 382 per sqkm</span></div></div></p>",
...
hoverlabelsPopD <- lapply(seq(nrow(states@data)), function(i) {
  ...
  paste0( '<p>', sprintf(
        ...
        <span style='float:right'> %s per sqkm</span>
        </div>
        </div>",
